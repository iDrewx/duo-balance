...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!supabase) {
      setError('No hay conexión a Supabase. Verifica la configuración.')
      setIsLoading(false)
      return
    }
    ...
    try {
      if (isSignUp) {
        ...
        // El usuario se creó, verificar email
        setError('¡Cuenta creada! Revisa tu email para confirmar, o puedes entrar directamente.')
        setIsSignUp(false)
      } else {
        // Login
